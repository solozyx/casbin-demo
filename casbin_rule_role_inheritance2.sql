...
CREATE DATABASE `casbin5` DEFAULT CHARACTER SET = `utf8mb4`;
use `casbin5`;
...
-- 测试 数据库设计不合理
INSERT INTO `casbin_rule` VALUES ('g', 3, 1, NULL, NULL, NULL, NULL);
INSERT INTO `casbin_rule` VALUES ('g', 3, 2, NULL, NULL, NULL, NULL);
